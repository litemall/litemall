...
import com.doopai.litemall.core.util.SystemInfoPrinter;
import com.doopai.litemall.database.service.LitemallSystemConfigService;
...
class SystemInistService {
    ...
    private Map<String, String> getSystemInfo() {
        ...
        // 测试获取application-database.yml配置信息
        ...
        infos.put("调试级别", environment.getProperty("logging.level.com.doopai.litemall.apollo"));
        ...
        infos.put("模版消息", environment.getProperty("litemall.notify.apollo.enable"));
        ...
        infos.put("微信APP KEY", environment.getProperty("litemall.apollo.app-id"));
        infos.put("微信APP-SECRET", environment.getProperty("litemall.apollo.app-secret"));
        infos.put("微信支付MCH-ID", environment.getProperty("litemall.apollo.mch-id"));
        infos.put("微信支付MCH-KEY", environment.getProperty("litemall.apollo.mch-key"));
        infos.put("微信支付通知地址", environment.getProperty("litemall.apollo.notify-url"));
